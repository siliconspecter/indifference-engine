...
/**
 * Indicates that no opaque and/or cutout mesh components were left to allocate.
 */
#define ERROR_NO_OPAQUE_CUTOUT_MESH_COMPONENTS_TO_ALLOCATE -9

/**
 * Indicates that no additive and/or blended mesh components were left to
 * allocate.
 */
#define ERROR_NO_ADDITIVE_BLENDED_MESH_COMPONENTS_TO_ALLOCATE -10

/**
 * Indicates that no tick components were left to allocate.
 */
#define ERROR_NO_TICK_COMPONENTS_TO_ALLOCATE -11
