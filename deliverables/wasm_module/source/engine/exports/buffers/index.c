...
const s32 maximum_video_columns = MAXIMUM_VIDEO_COLUMNS;
      ...
      item(1073741825, samples_per_tick)                                                                          \
          item(1073741826, audio_buffer)                                                                          \
              item(1073741827, maximum_video_rows)                                                                \
                  item(1073741828, maximum_video_columns)                                                         \
                      item(1073741829, safe_area_rows)                                                            \
                          item(1073741830, safe_area_columns)                                                     \
                              item(1073741831, video_buffer)                                                      \
                                  item(1073741832, pointer_state)                                                 \
                                      item(1073741833, pointer_row)                                               \
                                          item(1073741834, pointer_column)                                        \
                                              item(1073741835, persist)                                           \
                                                  item(1073741836, tick_progress)                                 \
                                                      item(1073741837, video_rows)                                \
                                                          item(1073741838, video_columns)                         \
                                                              item(1073741839, listener_location)                 \
                                                                  item(1073741840, listener_normal)               \
                                                                      item(1073741841, controller_states)         \
                                                                          item(1073741842, controller_y_axes)     \
                                                                              item(1073741843, controller_x_axes) \
                                                                                  item(1073741844, error)
