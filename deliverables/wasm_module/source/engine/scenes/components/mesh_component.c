...
static index first_occupied_opaque_cutout = INDEX_NONE;
...
static index first_occupied_additive_blended = INDEX_NONE;
...
static void set_mesh(const index meta, const mesh *const mesh)
{
  ...
  {
    FIND_EMPTY_INDEX(opaque_cutout_meshes, NULL, MAXIMUM_OPAQUE_CUTOUT_MESH_COMPONENTS, first_occupied_opaque_cutout, last_occupied_opaque_cutout, ERROR_NO_OPAQUE_CUTOUT_MESH_COMPONENTS_TO_ALLOCATE, opaque_cutout_index)
  ...
  {
    FIND_EMPTY_INDEX(additive_blended_meshes, NULL, MAXIMUM_ADDITIVE_BLENDED_MESH_COMPONENTS, first_occupied_additive_blended, last_occupied_additive_blended, ERROR_NO_ADDITIVE_BLENDED_MESH_COMPONENTS_TO_ALLOCATE, additive_blended_index)
...
{
  FIND_EMPTY_INDEX(transforms, NULL, MAXIMUM_MESH_COMPONENTS, first_occupied, last_occupied, ERROR_NO_MESH_COMPONENTS_TO_ALLOCATE, meta)
