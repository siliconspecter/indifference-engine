...
index timer_component(
    const index entity,
    const index meta,
    const timer_ticked *const on_tick,
    const timer_expired *const on_expiry);
