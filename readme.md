...
| ---------- | ----- | ------------------------------------------------ | ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `-1`       | `i32` | 1.                                               | Size of `i32`.                 | The number of ticks (game state updates) per second.                                                                                                                                                                                                            |
| `-2`       | `i32` | 1.                                               | Size of `i32`.                 | The number of audio samples per tick.                                                                                                                                                                                                                           |
| `-3`       | `f32` | 2 * number of audio samples per tick.            | Size of `f32`.                 | The audio output buffer, interleaved left-right where each sample ranges from -1 to 1.                                                                                                                                                                          |
...
| `-6`       | `i32` | Height of video buffer * height of video buffer. | Size of `i32`.                 | The video output buffer, running from left to right, then top to bottom.  The bytes, from least to most significant, represent the red, green and blue intensity where 0 is dark and 255 is bright, then the opacity, where 0 is transparent and 255 is opaque. |
| `-7`       | `i32` | 1.                                               | Size of `i32`.                 | The hosting runtime sets this value to state of the pointing device before calling `tick` (see below).                                                                                                                                                          |
...
| `-10`      | `i32` | 1.                                               | Size of `i32`.                 | The hosting runtime sets this value to `0` before calling `tick` (see below).  If `tick` changed this to `1`, the hosting runtime is permitted to persist all game state buffers, otherwise, it is not.                                                         |
| `-11`      | `f32` | 1.                                               | Size of `f32`.                 | The hosting runtime sets this value to `0` before calling `video` (see below).  This indicates the progress through the current tick, where `0` is the start and `1` is the end.                                                                                |
| `-12`      | `i32` | 4.                                               | Size of `i32`.                 | The hosting runtime sets each value within to the corresponding controller's state before calling `tick` (see below).                                                                                                                                           |
| `-13`      | `f32` | 4.                                               | Size of `f32`.                 | The hosting runtime sets each value within to the corresponding controller's X axis value before calling `tick`, where `-1` is fully left, `0` is centered and `1` is fully right.                                                                              |
| `-14`      | `f32` | 4.                                               | Size of `f32`.                 | The hosting runtime sets each value within to the corresponding controller's Y axis value before calling `tick`, where `-1` is fully down, `0` is centered and `1` is fully up.                                                                              |
...
| Export  | Description                                                                                                                                                                             |
| ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `tick`  | Executed once per game state update.  Additionally populates the audio output buffer.                                                                                                   |
